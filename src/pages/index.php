...
<div class="bg-[url('/yourpet/src/assets/images/home-hero.jpg')] w-full h-96 bg-cover bg-center">

</div>

<div class="flex flex-col gap-10 justify-center items-center mx-auto p-10 my-10 w-3/5 h-80 bg-[#0e2a33]">
    <span class="flex text-3xl font-semibold gap-2 mt-5 text-white">
        <h1 class="">We care about</h1><h1 class="text-[#93bbbd] font-bold underline">Your Pet</h1>
    </span>
